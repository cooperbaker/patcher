...
#
# 1. Follow patcher sd card flashing instructons in README.md
# 2. Run this command from a fresh OS image to install patcher:
# $  curl https://raw.githubusercontent.com/cooperbaker/patcher/refs/heads/main/lib/os/install.sh | bash
#
# Cooper Baker (c) 2024
...
ln -sv /home/pi/patcher/lib/os/zshrc .zshrc
sudo ln -sv /home/pi/patcher/lib/os/zshrc /root/.zshrc
echo ""
...
#-------------------------------------------------------------------------------
# configure samba - MacOS : smb://pi:raspberry@patcher/pi
#-------------------------------------------------------------------------------
...
sudo cat /home/pi/patcher/lib/os/smb.conf | sudo tee -a /etc/samba/smb.conf
...
sudo ln -sv /home/pi/patcher/lib/os/midi.service /etc/systemd/system/midi.service
